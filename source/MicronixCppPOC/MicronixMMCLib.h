...
std::string pollValues(std::string axis, std::string sendCommand);
bool writeCommandToMMC(std::string axis, std::string sendCommand);
...
public:
    ...
    // Open a device
    char openDevice(const char* Device, const unsigned int Bauds = 38400,
    ...
    int     readString(char* receivedString, char finalChar = '\r',
        unsigned int maxNbBytes = 1,
